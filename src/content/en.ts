  ...
  legal: {
    notice: {
      ...
      sections: [
        ...
        {
          heading: "French establishment",
          body: "Digital Management Ltd carries out its prospecting and service activity in France from its establishment at 3 Résidence des Écoles, 09000 Ferrières-sur-Ariège, France (SIRET: [registration pending]). For data processing carried out from this establishment, the competent supervisory authority is the CNIL (cnil.fr).",
        },
