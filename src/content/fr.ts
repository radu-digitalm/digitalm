...
export const fr = {
  ...
  smb: {
    ...
    priceChip: "Sites dès 500 € · IA dès 500 €/jour · suivi 150 €/mois",
  ...
  pricing: {
    ...
    guarantee:
      "Prix fixe, défini à l'avance — aucune facture surprise. Nous ajustons le périmètre jusqu'à votre validation. Pour le suivi mensuel : prix fixe, grille publiée, arrêt en un e-mail — sans frais.",
    diagnostic: {
    ...
    packages: [
      {
        name: "Boutique en ligne + IA",
        price: "à partir de 5 000 €",
        originalPrice: "à partir de 7 500 €",
        timeline: "2–3 semaines",
        outcome: "Une vraie boutique en ligne, avec l'IA intégrée dès le départ.",
        includes: [
          "Catalogue, paiement et livraison en place",
          "IA intégrée : réponses clients, contenu produit",
          "Formation à la prise en main incluse",
          "1er mois de Veille offert — activé seulement si vous le souhaitez",
        ],
    ...
    audit: {
      name: "Audit de sécurité e-commerce",
      price: "à partir de 500 €/jour",
      originalPrice: "à partir de 750 €/jour",
      timeline: "selon le périmètre",
      outcome: "Sachez où votre site ou boutique est exposé — constats priorisés, correctifs, focus paiement et données clients, nouveau test après corrections.",
      includes: [],
      cta: "Demander un audit",
    },
    care: {
      eyebrow: "Tranquillité — le suivi mensuel",
      title: "On ne disparaît pas une fois le site livré.",
      body: "Comme pour une chaudière ou une camionnette : un entretien régulier coûte moins cher que la panne. Une demi-journée d'intervention coûte 250 € ; un mois de Veille en coûte 150 — et vous n'avez plus à y penser.",
      overageRule: "Au-delà du forfait, on vous prévient avant et on vous propose un devis. Jamais de facture surprise.",
      honesty: "On vous dit quel niveau se justifie chez vous — y compris « aucun ».",
      mechanics: "Arrêt par e-mail, effet fin de mois, aucun prorata, aucun frais.",
      tiers: [
        {
          name: "Veille",
          price: "150 €/mois",
          timeline: "mensuel · sans engagement",
          outcome: "Votre site et votre IA restent en ligne, à jour et surveillés — sans que vous y pensiez.",
          includes: [
            "On veille : site, IA, sauvegardes, sécurité, mises à jour",
            "Pannes sur ce que nous avons construit : réparées sans supplément",
            "1 petite modification par mois (texte, photo, horaires — 15 min max)",
            "Compte-rendu mensuel en français clair : ce qu'on a fait, ce qu'on a vu",
          ],
        ...
        },
        {
          ...
          price: "500 €/mois",
          timeline: "mensuel · sans engagement",
          outcome: "Toute la Veille, plus une journée d'équipe chaque mois, à vous.",
          includes: [
            "Tout Veille + 1 jour de travaux au choix chaque mois",
            "Relecture mensuelle des réponses de votre IA, corrections incluses",
            "Appel mensuel de 30 min + vérification sécurité annuelle",
            "À l'unité, ça coûterait ≈ 650 € — en suivi régulier, 500 €",
          ],
          lead: true,
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Oui. Le site, le code et le contenu vous appartiennent. Et cela ne change pas si vous prenez — ou arrêtez — le suivi mensuel.",
      },
      {
        q: "Que se passe-t-il après la mise en ligne ?",
        a: "Chaque forfait inclut 30 jours de suivi. Ensuite : vous gérez vous-même — tout vous appartient — ou nous continuons avec le suivi mensuel à prix fixe, 150 ou 500 €/mois, arrêt en un e-mail. Sans suivi, votre site continue de tourner ; ce qui bouge, ce sont les modèles IA et votre activité. On vous dit quel niveau se justifie — y compris « aucun ».",
      },
    ],
  },
