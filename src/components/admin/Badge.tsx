...
export function Badge({
  ...
  return (
    <span title={title} className={`inline-flex items-center whitespace-nowrap rounded-full border px-2.5 py-1 text-[15px] font-medium leading-tight ${VARIANT[variant]} ${className}`}>
      {children}
    </span>
  );
}
