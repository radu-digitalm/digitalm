...
// page's requireAdmin() call, never this shell. Base type 16 px (17 px from xl),
...
export function AdminShell({ subject, children }: { subject: string | null; children: React.ReactNode }) {
  return (
    <div lang="en" className="admin-root min-h-screen bg-ink text-[16px] leading-relaxed text-fg xl:text-base">
      <header className="sticky top-0 z-40 border-b border-line bg-ink/95 backdrop-blur">
        <div className="mx-auto flex max-w-content items-center gap-4 px-4 py-3 sm:gap-6 sm:px-6">
          <Link href="/admin" className="shrink-0 font-display text-[18px] text-fg-heading">
